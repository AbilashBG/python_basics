...
#  this function is used for show list of books 
    def list_books(self):
        print("Available Books")
        for book in self.books:
            print(book)
 
#  this function is used for borrow book 
...
#  this function is used for receive book 
    def receive_book(self, receive_book):
        print("You have returned the book")
        self.books.append(receive_book)
 
#  this book list will add in the initial method by assigning the object for the class
books = ['C', 'C++', 'Java']
o = Library(books)
